Public Class Person
    ...
    End Sub
    Public Sub New(fornavn As String, etternavn As String, personnummer As String,
    ...
    Public Sub regPerson()
        db.Query("INSERT INTO Person(fornavn, etternavn, telefon, epost, postnummer, adresse, personnummer) VALUES('" & fornavn & "', '" & etternavn &
                 "', '" & telefon & "', '" & epost & "', '" & postnummer & "', '" & adresse & "', '" & personnummer & "')")
    End Sub
